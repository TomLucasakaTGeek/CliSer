  ...
  return (
    <div className='px-4 sm:px-20 xl:px-32 my-24'>
      <div className='text-center'>
        <h2 className='bg-gradient-to-t from-green-500 via-red-500 to-blue-500 text-transparent bg-clip-text text-[42px] font-semibold'>Powerful AI Tools</h2>
        <p className='text-lime-500 max-w-lg mx-auto'>Everything you need to create, enhance, and optimize your content with cutting-edge AI Technology.</p>
      </div>
